...
class CreateEvezplaceRecommendationsTable extends Migration {
	...
	public function up()
	{
		Schema::create('evezplace_recommendations', function(Blueprint $table)
		{
			$table->increments('id');
	...
	{
		Schema::drop('evezplace_recommendations');
	}
