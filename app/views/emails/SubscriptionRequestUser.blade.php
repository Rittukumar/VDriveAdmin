                    ...
                    <td valign="top">
                        <div style="max-width:600px;margin:0 auto;padding:0 12px">
                            <div style="background:white;border-radius:0.5rem;padding:2rem;margin-bottom:1rem">
                                <h2 style="color:#2ab27b;margin:0 0 12px;line-height:30px">Store subscription request</h2>
                                <p>You Subscription request for Store : {{ $name }} is under processing, you will receive a mail regarding the subscription offer within next 24 hours</p><br>
